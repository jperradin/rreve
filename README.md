...
`rreve` is designed for researchers, scientists, and students in computational materials science, condensed matter physics, and physical chemistry, particularly those who:
...
`rreve` offers a comprehensive suite of tools for the structural analysis of atomic systems.

-----

### **Analysis Capabilities**

`rreve` provides various analyzers to quantify structural properties of your systems:
...
To install `rreve` as a package, you can use pip:
...
```bash
git clone git@github.com:jperradin/rreve.git
```
